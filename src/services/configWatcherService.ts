...
export const validateConfig = (): void => {
    ...
    if (
        config.missionPlatinumRewardMin !== undefined &&
        (!Number.isInteger(config.missionPlatinumRewardMin) || config.missionPlatinumRewardMin < 0)
    ) {
        config.missionPlatinumRewardMin = 0;
        modified = true;
    }
    if (
        config.missionPlatinumRewardMax !== undefined &&
        (!Number.isInteger(config.missionPlatinumRewardMax) || config.missionPlatinumRewardMax < 0)
    ) {
