...
import { applyLiveTeshinRotation } from "../../services/liveWorldStateService.ts";

const TESHIN_VENDOR = "/Lotus/Types/Game/VendorManifests/Hubs/TeshinHardModeVendorManifest";
...
export const getVendorInfoController: RequestHandler = async (req, res) => {
    ...
    if (req.query.vendor == TESHIN_VENDOR) {
        manifest = applyLiveTeshinRotation(manifest);
    }
