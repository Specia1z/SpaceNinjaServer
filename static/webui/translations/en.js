dict = {
    ...
    navbar_accountRates: `Account Rates`,
    accountRates_title: `Account Rate Manager`,
    accountRates_description: `Configure independent reward multipliers for each account. Changes apply through the server settlement pipeline.`,
    accountRates_refresh: `Refresh`,
    accountRates_search: `Search accounts`,
    accountRates_configured: `configured`,
    accountRates_custom: `Custom`,
    accountRates_noAccounts: `No accounts match the search.`,
    accountRates_noSelection: `Select an account to edit its reward profile.`,
    ...
    accountRates_groupMission: `Mission settlement`,
    ...
    accountRates_creditMultiplierHint: `Credits awarded during mission settlement, before boosters.`,
    accountRates_focusXpMultiplier: `Focus XP`,
    accountRates_focusXpMultiplierHint: `Focus XP reported by a completed mission.`,
    accountRates_standingMultiplier: `Syndicate standing`,
    accountRates_standingMultiplierHint: `Standing awarded by bounties and conservation.`,
    accountRates_nightwaveStandingMultiplier: `Nightwave standing`,
    accountRates_nightwaveStandingMultiplierHint: `Standing from completed Nightwave challenges.`,
    accountRates_relicRewardMultiplier: `Relic item count`,
    accountRates_relicRewardMultiplierHint: `Item count received when opening a Void relic.`,
    accountRates_relicPlatinumMultiplier: `Relic platinum`,
    accountRates_relicPlatinumMultiplierHint: `Configured platinum reward attached to relic rarity.`,
    accountRates_missionPlatinumMultiplier: `Mission platinum`,
    accountRates_missionPlatinumMultiplierHint: `Custom platinum awarded by successful mission completion.`,
    accountRates_dailyTributeMultiplier: `Daily tribute`,
    accountRates_dailyTributeMultiplierHint: `Amount and duration of random daily login rewards.`,
    accountRates_save: `Save profile`,
    accountRates_reset: `Reset draft`,
    accountRates_delete: `Remove profile`,
    accountRates_invalidValue: `Enter valid values within the allowed range.`,
    accountRates_saved: `Account rate profile saved.`,
    accountRates_deleted: `Account rate profile removed.`,
    accountRates_unsavedConfirm: `Discard unsaved account rate changes?`,
    accountRates_deleteConfirm: `Remove this account's custom rate profile and restore normal 1x behavior?`,
    ...
    cheats_relicRewardItemCountMultiplier: `Relic Reward Item Count Multiplier (Does Not Affect Platinum)`,
    ...
    cheats_relicPlatinumRewardCommon: `Relic Common Reward Platinum`,
    cheats_relicPlatinumRewardUncommon: `Relic Uncommon Reward Platinum`,
    cheats_relicPlatinumRewardRare: `Relic Rare Reward Platinum`,
    cheats_relicPlatinumRewardHint: `Awards the configured amount for the relic reward the player ultimately selects. Set to 0 to disable.`,
    ...
    admin_ircTitle: `Global IRC Announcement`,
    admin_ircMessage: `Announcement`,
    admin_ircDescription: `Sends red text to every player currently connected to IRC (up to 400 UTF-8 bytes).`,
    admin_ircSend: `Broadcast to All`,
    admin_ircConfirm: `Broadcast this red announcement to all online players?`,
    admin_ircInvalid: `Enter a single-line announcement of up to 400 UTF-8 bytes.`,
    admin_ircSent: `IRC announcement submitted to the chat server.`,
    admin_ircFailed: `Could not send the IRC announcement. Check administrator access.`,
    admin_ircUnavailable: `IRC announcement service is unavailable.`,
    ...
    navbar_metadataPatches: `Metadata Patches`,
    metadataPatches_title: `Metadata Patches`,
    metadataPatches_description: `Configure game Metadata Patches delivered to compatible OpenWF Bootstrapper clients. Later entries take precedence when several patches assign the same field.`,
    metadataPatches_restartHint: `Saving updates connected Bootstrapper clients immediately, but metadata already loaded by the game requires a full game restart.`,
    metadataPatches_importLabel: `Import Metadata Patch DSL`,
    metadataPatches_importPlaceholder: `/Lotus/Upgrades/Mods/Example
q|Upgrades.0.Value|0.9090909`,
    metadataPatches_importHint: `Paste existing Metadata Patches.txt instructions. Targets begin with / or >; comments are ignored.`,
    metadataPatches_import: `Import into editor`,
    metadataPatches_importInvalidTarget: `Every imported patch must start with an absolute /Lotus/... target.`,
    metadataPatches_importMissingTarget: `An operation was found before the first metadata target.`,
    metadataPatches_copy: `Copy preview`,
    metadataPatches_copied: `Compiled patch copied to clipboard.`,
    metadataPatches_copyFailed: `Could not copy the compiled patch.`,
    metadataPatches_add: `Add patch`,
    metadataPatches_save: `Save all`,
    metadataPatches_enabled: `Enabled`,
    metadataPatches_name: `Name`,
    metadataPatches_targets: `Metadata targets`,
    metadataPatches_targetsHint: `One absolute /Lotus/... path per line.`,
    metadataPatches_operations: `Patch operations`,
    metadataPatches_operationsHint: `One Metadata Patch DSL instruction per line, such as q|Upgrades.0.Value|0.9090909.`,
    metadataPatches_moveUp: `Move up`,
    metadataPatches_moveDown: `Move down`,
    metadataPatches_delete: `Delete patch`,
    metadataPatches_empty: `No server Metadata Patches are configured.`,
    metadataPatches_preview: `Compiled server patch`,
    metadataPatches_emptyPreview: `No enabled patch output.`,
    metadataPatches_revision: `Revision`,
    metadataPatches_invalidTarget: `Patch |INDEX| needs at least one absolute metadata target beginning with /.`,
    metadataPatches_saved: `Metadata Patches saved and sent to connected clients.`,
